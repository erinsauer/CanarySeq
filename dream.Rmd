...
#MG effect
variancePartition::topTable( fitmm, coef='MG.activeYES',number = Inf#, p.value = 0.2
...
variancePartition::topTable( fitmm, coef='Dietprotein',number = Inf) %>% rownames_to_column("gene") #%>% View()
