...
# factoextra::fviz_nbclust(k.max = 54, df, factoextra::hcut, method = "gap_stat", nboot = 500) +
# # geom_vline(xintercept = 4, linetype = 2)+
...
```
### 4A part II: table Table of genes DE in infection, eye score, and pathogen load analyses
...
### 4B: network plot of genes DE accoridng to Eye Scores.
