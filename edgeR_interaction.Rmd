...
#design <- model.matrix(~ Diet_ixn+tolerance_1+Diet_ixn:tolerance_1)#+ Day_tolerance)
...
# 
# gene_expression_matrix_inf <- gene_expression_matrix_ixn[, metadata_phenotypes_ixn$MG.active == "YES"]
...
# res_ES_ixn <-  glmQLFTest(fit_ES, contrast=contrast_ixn_ES[,1])
